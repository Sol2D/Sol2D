...
const char LuaTypeName::point[]                          = "Point";
const char LuaTypeName::size[]                           = "Size";
const char LuaTypeName::color[]                          = "Color";
const char LuaTypeName::dimension[]                      = "Dimension";
const char LuaTypeName::fragment[]                       = "Fragment";
const char LuaTypeName::distance_joint_definition[]      = "DistanceJointDefinition";
const char LuaTypeName::motor_joint_definition[]         = "MotorJointDefinition";
const char LuaTypeName::mouse_joint_definition[]         = "MouseJointDefinition";
const char LuaTypeName::prismatic_joint_definition[]     = "PrismaticJointDefinition";
const char LuaTypeName::revolute_joint_definition[]      = "RevoluteJointDefinition";
const char LuaTypeName::weld_joint_definition[]          = "WeldJointDefinition";
const char LuaTypeName::wheel_joint_definition[]         = "WheelJointDefinition";
const char LuaTypeName::body_definition[]                = "BodyDefinition";
const char LuaTypeName::body_options[]                   = "BodyOptions";
const char LuaTypeName::sprite_definition[]              = "SpriteDefinition";
const char LuaTypeName::sprite_sheet_options[]           = "SpriteSheetOptions";
const char LuaTypeName::widget_padding[]                 = "WidgetPadding";
